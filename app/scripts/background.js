...
/***/ function(module, exports, __webpack_require__) {
	...
	_storage2.default.get().then(onReady);
	...
	function onReady(aliases) {
	  chrome.omnibox.onInputChanged.addListener(function (text, suggest) {
	    ...
	    var filtered = aliases.filter(function (aliasData) {
	      return re.test(aliasData.alias);
	    });
	    var sorted = filtered.sort(function (a, b) {
	      return b.lastEnter - a.lastEnter;
	    });
	    var mapped = sorted.map(function (aliasData) {
	      return {
	        content: (0, _lodash4.default)(aliasData.url),
	  ...
	  chrome.omnibox.onInputEntered.addListener(function (text) {
	    var idx = aliases.findIndex(function (aliasData) {
	      return aliasData.url === (0, _lodash2.default)(text);
	    });

	    if (~idx) {
	      var url = aliases[idx].url;

	      chrome.tabs.update({ url: url });

	      aliases[idx].lastEnter = Date.now();
	      _storage2.default.set(aliases);
	    }
	  });
	}
...
/***/ function(module, exports) {
	...
	var storage = {
	  set: function set(_aliases) {
	    return new Promise(function (resolve) {
	      var aliases = _aliases.sort(function (a, b) {
	        return b.lastEnter - a.lastEnter;
	      });
	  ...
	  get: function get() {
	    return new Promise(function (resolve) {
	      chrome.storage.sync.get('aliases', function (_ref) {
