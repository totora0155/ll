...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodash5 = __webpack_require__(7);
	...
	function onReady(aliases) {
	  chrome.omnibox.onInputChanged.addListener(function (text, suggest) {
	    ...
	    var mapped = sorted.map(function (aliasData) {
	      return {
	        content: (0, _lodash6.default)(aliasData.url),
	  ...
	  chrome.omnibox.onInputEntered.addListener(function (text) {
	    ...
	    idx = aliases.findIndex(function (aliasData) {
	      return aliasData.url === (0, _lodash2.default)(text);
	    });
	    if (! ~idx) {
	      idx = aliases.findIndex(function (aliasData) {
	        var re = new RegExp((0, _lodash4.default)(text));
